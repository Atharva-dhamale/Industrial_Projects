...
//  Description:        Holds the information about the FileSystem
//
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//  Description :   It is used to initialise urea members
...
void CreateDILB()
{
    ...
    printf("Marvellous CVFS : DILB Succesfully created\n");
}
...
//  Output      :   It returns boolean value (true or false)
//  Author      :   Atharva Kailash Dhamale
//  Date        :   16/01/2026
//
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
bool IsFileExist(char *name)    //Parameter is FileName
{
    PINODE temp=head;
    bool bFlag=false;
...
//  Input       :   File descriptor , Address of buffer which contains data , size of data that we want to write 
...
//  Input       :   File descriptor , Address of empty buffer , size of data that we want to read 
...
int main()
{
    ...
    while(1)
    {
        ...
        else if(iCount==3)
        {
            ...
            {
                iRet=CreateFile(Command[1],atoi(Command[2]));       //atoi is a build in function of ascii to integer(typecast)

                if(iRet==ERR_INVALID_PARAMETER)
                {
                    printf("Error : Unable to create the file as parameters are invalid\n");
                    printf("Please refer manpage\n");
                }
